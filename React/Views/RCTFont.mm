...
RCT_ENUM_CONVERTER(
    ...
    (@{
      ...
      @"bold" : @(UIFontWeightRegular),
      @"100" : @(UIFontWeightRegular),
      @"200" : @(UIFontWeightRegular),
      @"300" : @(UIFontWeightRegular),
      @"400" : @(UIFontWeightRegular),
      @"500" : @(UIFontWeightRegular),
      @"600" : @(UIFontWeightRegular),
      @"700" : @(UIFontWeightRegular),
      @"800" : @(UIFontWeightRegular),
      @"900" : @(UIFontWeightRegular),
    }),
    UIFontWeightRegular,
    doubleValue)
